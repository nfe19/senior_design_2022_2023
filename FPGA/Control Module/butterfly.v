...
module	butterfly #(
		...
		parameter	MPYDELAY=((MXMPYBITS+1)/2)+2,
		// }}}
		// LCLDELAY
		// {{{
		//
		...
		parameter	LCLDELAY = (CKPCE == 1) ? MPYDELAY
			: (CKPCE == 2) ? (MPYDELAY/2+2)
			: (MPYDELAY/3 + 2),
		// }}}
		// LGDELAY
		// {{{
		parameter	LGDELAY = (MPYDELAY>64) ? 7
			: (MPYDELAY > 32) ? 6
			: (MPYDELAY > 16) ? 5
			: (MPYDELAY >  8) ? 4
			: (MPYDELAY >  4) ? 3
			: 2,
		// }}}
		parameter	AUXLEN=(LCLDELAY+3),
		parameter	MPYREMAINDER = MPYDELAY - CKPCE*(MPYDELAY/CKPCE)
		// }}}
		// }}}
	) (
		// {{{
