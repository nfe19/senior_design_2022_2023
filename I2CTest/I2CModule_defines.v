...
// FFT i2c registers
`define DEV_ID_REG 8'h00
`define VERSION_ID_REG 8'h01
`define CONTROL_REG 8'h02
`define STATUS_REG 8'h03
`define DATA_LO_REG 8'h04
`define DATA_HI_REG 8'h05
`define FFTRESERVED0 8'h06
`define FFTRESERVED1 8'h07

// FFT FPGA DEFINES
`define SCLFPGA 1'b1
`define NOTSCLFPGA  1'b0
`define RSTFPGA 1'b0
`define NOTRSTFPGA  1'B1
// ----------------------------------------------------------------
